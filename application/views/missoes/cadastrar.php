                        ...
                        <form role="form" method="POST" action="<?php echo site_url($this->router->class . '/DB?acao=salvar');?>" enctype="multipart/form-data">
                            ...
                            <div class="form-etapa-1">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-2 col-xs-2">
                                        <input type="text" class="form-control input-sm mascara-data-hora" name="data_hora_inicio" id="data_hora_inicio" tabindex="1" onblur="calcular_diferenca_data(this, $('#data_hora_final'));">
                                    </div>
                                    <label for="" class="col-lg-2 col-xs-2 control-label">Data e Hora Final</label>
                                    <div class="col-lg-2 col-xs-2">
                                        <input type="text" class="form-control input-sm mascara-data-hora" name="data_hora_final" id="data_hora_final" tabindex="1" onblur="calcular_diferenca_data($('#data_hora_inicio'), this);">
                                    </div>
                                ...
                                <div class="form-group area-horas-extras hidden">
                                    ...
                                    <div class="col-lg-2 col-xs-2">
                                        <input type="text" class="form-control input-sm" tabindex="1" name="hora_extra_quantidade" id="hora_extra_quantidade" readonly>
                                    </div>
                                    <label for="" class="col-lg-2 col-xs-2 control-label">Adicional Hora Extra (R$)</label>
                                    <div class="col-lg-2 col-xs-2">
                                        <input type="text" class="form-control input-sm somar-total" tabindex="1" name="hora_extra_valor" id="hora_extra_valor" readonly>
                                    </div>
                                ...
                                <div class="form-group area-km-extras hidden">
                                    ...
                                    <div class="col-lg-2 col-xs-2">
                                        <input type="text" class="form-control input-sm" tabindex="1" name="km_extra_quantidade" id="km_extra_quantidade" readonly>
                                    </div>
                                    <label for="" class="col-lg-2 col-xs-2 control-label">Adicional KM Extra (R$)</label>
                                    <div class="col-lg-2 col-xs-2">
                                        <input type="text" class="form-control input-sm somar-total" tabindex="1" name="km_extra_valor" id="km_extra_valor" readonly>
                                    </div>
                            ...
                            <div class="form-etapa-2 aba-area">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-1 col-xs-1">
                                        <input type="checkbox" class="form-control checkbox-medio input-sm" name="feriado" id="feriado" tabindex="1">
                                    </div>
                                </div>
