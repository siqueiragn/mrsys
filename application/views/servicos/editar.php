                            ...
                            <div class="col-lg-12 col-xs-12">
                                ...
                                <div class="form-etapa-4 aba-area">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-2 col-xs-2">
                                            <input type="text" class="form-control input-sm mascara-dinheiro" tabindex="1" name="valor_batida_agente" id="valor_batida_agente" placeholder="0,00" value="<?php echo $objeto->valor_batida_extra;?>" >
                                        </div>
